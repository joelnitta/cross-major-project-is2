...
<https://joelnitta.github.io/cross-major-project-is2/#/データ解析>
...
- `data_cleaning.R`をダウンロードして、このプロジェクトに保存してください。

- `data_cleaning.R`を開いて、実行すると、`data/okujo_2024.csv`が出力される

- `data/okujo_2024.csv`を読み込む
